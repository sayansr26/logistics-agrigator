...
export const API_ENDPOINTS = {
  ...
  GEOGRAPHICAL: {
    ...
    CREATE: "/api/v1/geographical",
    EDIT: "/api/v1/geographical",
    DELETE: "/api/v1/geographical",
    GET: "/api/v1/geographical",
    STATS: "/api/v1/geographical/stats",
    STATES: "/api/v1/geographical/states",
    CITIES: "/api/v1/geographical/cities",
    AREAS: "/api/v1/geographical/areas",
    PINCODES: "/api/v1/geographical/pincodes",
    SEARCH: "/api/v1/geographical/search",
    DETAILS: "/api/v1/geographical/details",
    HIERARCHY: "/api/v1/geographical/hierarchy",
    HIERARCHY_DETAILS: "/api/v1/geographical/hierarchy/details",
    HIERARCHY_SEARCH: "/api/v1/geographical/hierarchy/search",
  },
} as const;
