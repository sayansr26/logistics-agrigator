...
export const ROUTE_PERMISSIONS: RoutePermission[] = [
  ...
  {
    path: "/partners/:id/carrier-accounts",
    public: false,
    roles: ["superadmin", "admin"],
    permission: "partner:update:*",
    title: "Carrier Accounts",
    description: "Weight-slab carrier accounts/channels",
  },
  {
    path: "/partners",
    public: false,
  ...
  },
  {
    ...
    description: "COD reconciliation and settlement workflow",
  },
  {
    path: "/cod/shipments",
    public: false,
    ...
    permission: "wallet:manage:*",
    title: "COD Shipments",
    description: "COD shipments and reconciliation",
  },
  {
    path: "/cod/my-settlements",
    public: false,
    permission: "wallet:read:*",
    title: "My Settlements",
    description: "Customer COD settlement portal",
  },
  {
    path: "/shipments/bulk-rerate",
    public: false,
    permission: "shipment:update:*",
