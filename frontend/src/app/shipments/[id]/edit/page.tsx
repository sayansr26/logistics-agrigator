...
const PRIORITY_OPTIONS: Shipment["priority"][] = [
  "low",
  "medium",
  "high",
  "urgent",
...
const PAYMENT_OPTIONS: Shipment["paymentMode"][] = [
  "prepaid",
  "cod",
  "credit",
  "wallet",
...
const COURIER_OPTIONS = ["DHL Express", "FedEx", "UPS", "Aramex"] as const;
...
export default function EditShipmentPage() {
  ...
  const [form, setForm] = useState<EditableShipment | null>(null);
  ...
  const handleChange = <K extends keyof EditableShipment>(
    key: K,
    value: EditableShipment[K],
  ) => {
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                value={form?.status}
                onValueChange={(v) =>
                  handleChange("status", v as Shipment["status"])
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={form?.priority}
                onValueChange={(v) =>
                  handleChange("priority", v as Shipment["priority"])
                }
              >
                <SelectTrigger>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  handleChange(
                    "courierPartner",
                    v as EditableShipment["courierPartner"],
                  )
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  handleChange("paymentMode", v as Shipment["paymentMode"])
                }
              >
                <SelectTrigger>
